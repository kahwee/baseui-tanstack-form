...
describe('CheckboxGroup Component', () => {
  ...
  it('allows selecting multiple checkboxes', async () => {
    ...
    const technologyCheckbox = screen
      ...
      .closest('label')
      ?.querySelector('input')
    const scienceCheckbox = screen.getByText('Science').closest('label')?.querySelector('input')
  ...
  it('renders with default values', () => {
    ...
    const technologyCheckbox = screen
      ...
      ?.querySelector('input')
    const scienceCheckbox = screen.getByText('Science').closest('label')?.querySelector('input')
    const artCheckbox = screen.getByText('Art').closest('label')?.querySelector('input')
  ...
  it('displays checkboxes inline when inline prop is true', () => {
    ...
    const groupContainer = container.querySelector('fieldset')
  ...
  it('has proper ARIA attributes', () => {
    ...
    const groupContainer = container.querySelector('fieldset')
    expect(groupContainer).toHaveAttribute('aria-label', 'Select your interests')
  })
})
