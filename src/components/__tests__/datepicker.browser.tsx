...
describe('DatePicker component', () => {
      ...
      return (
        <form>
          <form.AppField name={fieldName} validators={{ onChange: validate }}>
            {(field) => <field.DatePicker label="Event Date" {...customProps} />}
          </form.AppField>
        </form>
      )
    }
  ...
  describe('Edge cases and special behaviors', () => {
    it('handles array of dates (for range pickers)', () => {
      ...
      const TestComponent = createDatePickerComponent(dateRange, {}, '', 'dateRange')
      render(<TestComponent />)
    ...
    const TestOnChangeComponent = () => {
      ...
      return (
        <div>
          ...
          <button type="button" data-testid="set-single-date" onClick={handleSingleDate}>
            Set Single Date
          </button>
          <button type="button" data-testid="set-date-array" onClick={handleDateArray}>
            Set Date Array
          </button>
          <button type="button" data-testid="set-null-date" onClick={handleNullDate}>
            Set Null Date
          </button>
        </div>
      )
