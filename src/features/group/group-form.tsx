      ...
      <Card>
        <StyledBody>
          ...
          <Block marginBottom="16px">
            ...
            <form.AppField mode="array" name="people">
              {(field) => (
                <div key={`s${field.state.value.length}`}>
                  {field.state.value.map((_, index) => (
                    ...
                    >
                      ...
                      <form.AppField name={`people[${index}].firstName`}>
                        {(subField) => <subField.Input label="First name" />}
                      </form.AppField>
                      <form.AppField name={`people[${index}].lastName`}>
                        {(subField) => <subField.Input label="Last name" />}
                      </form.AppField>
                      <form.AppField name={`people[${index}].bio`}>
                        {(subField) => <subField.Textarea label="Biography" />}
                      </form.AppField>
                      <form.AppField name={`people[${index}].sex`}>
                        {(subField) => (
                          <subField.RadioGroup
                            label="Sex"
                            options={[
                      ...
                      <form.AppField name={`people[${index}].role`}>
                        {(subField) => (
                      ...
                      <form.AppField name={`people[${index}].instruments`}>
                        {(subField) => (
