...
const fleetwoodMacMembers = [
  { id: 'stevie-nicks', label: 'Stevie Nicks', description: 'Vocals, Tambourine' },
  { id: 'christine-mcvie', label: 'Christine McVie', description: 'Keyboard, Vocals' },
  { id: 'lindsey-buckingham', label: 'Lindsey Buckingham', description: 'Guitar, Vocals' },
  { id: 'mick-fleetwood', label: 'Mick Fleetwood', description: 'Drums' },
  { id: 'john-mcvie', label: 'John McVie', description: 'Bass Guitar' },
  { id: 'peter-green', label: 'Peter Green', description: 'Guitar, Vocals (Former Member)', disabled: true }
];
